...
This is the **foundation phase**: data models, a realistic synthetic
dataset, and the core business-logic/service layer. Dashboards,
automation/alerting, and AI-assisted analysis build on top of this in
later phases.
